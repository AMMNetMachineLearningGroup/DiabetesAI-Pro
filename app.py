...
with st.sidebar:
    ...
    <div style='text-align:center; padding: 16px 0 24px 0;'>
      ...
      <div style='font-size:1.2rem; font-weight:700; color:#38bdf8;'>DiabetesAI Pro</div>
      <div style='font-size:0.75rem; color:#64748b; margin-top:4px;'>Clinical Decision Support</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    Dataset: Pima Indian Diabetes<br>
    Models: LR · KNN · SVM<br>
    XAI: SHAP KernelExplainer<br>
    <br>⚠ For research/education only
    </div>
    """, unsafe_allow_html=True)
